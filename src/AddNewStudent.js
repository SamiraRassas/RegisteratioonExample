...
export default function AddNewStudent(newStudent) {
  ...
  return (
    <div>
      <div>{JSON.stringify(newstudent)}</div>
      ...
      <form>
        ...
        <label>
          Enter your courses:
          <input type="text" value={courses} onChange={handleCourse} />
        </label>
        <br></br>
        <br></br>
        <label>
          Enter registeration status:
        ...
        <label>
          Enter your payment:
          <input type="text" value={paid} onChange={handlePaid} />
        </label>
        <br></br>
        <br></br>
      </form>
